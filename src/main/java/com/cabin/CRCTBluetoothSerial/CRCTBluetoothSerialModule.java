package com.cabin.CRCTBluetoothSerial;
...
import static com.cabin.CRCTBluetoothSerial.CRCTBluetoothSerialPackage.TAG;

@SuppressWarnings("unused")
public class CRCTBluetoothSerialModule extends ReactContextBaseJavaModule implements ActivityEventListener, LifecycleEventListener {
    ...
    private CRCTBluetoothSerialService mBluetoothService;
    ...
    public CRCTBluetoothSerialModule(ReactApplicationContext reactContext) {
        super(reactContext);
        ...
        if (mBluetoothService == null) {
            mBluetoothService = new CRCTBluetoothSerialService(this);
        }
