 ...
 */
class CRCTBluetoothSerialService {
    // Debugging
    ...
    private CRCTBluetoothSerialModule mModule;
     ...
     */
    CRCTBluetoothSerialService(CRCTBluetoothSerialModule module) {
    ...
    private void connectionFailed() {
        ...
        CRCTBluetoothSerialService.this.stop(); // Start the service over to restart listening mode
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            synchronized (CRCTBluetoothSerialService.this) {
                mConnectThread = null;
            }
